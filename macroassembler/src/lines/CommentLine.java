...
/** Extends Line Class , implements specific functionality for comment lines
 */
public class CommentLine extends Line{
     ...
     */
    public CommentLine(int srcLineNum, String txt) {
     ...
     *  For a comment the address returned should be the
