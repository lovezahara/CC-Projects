...
def UserMenu():
    ...
    while menu:
        ...
        user_txt = pygame.font.SysFont('Corbel', 60)
        user = user_txt.render("Welcome User!", True, (250, 250, 250))
        #renders Font objects
        user_rect = user.get_rect(center=(200, 150))
        #gets rectangle based on user and centers

        instr = pygame.font.SysFont("Corbel", 30)
        instr_txt = instr.render("Please your intitials", True, (250, 250, 180))
        
        screen.blit(instr_txt, (80, 200))
        #shows instr_txt
        
        rect_txt = pygame.font.SysFont('Corbel', 30)
        text_rect = rect_txt.render("Submit", True, (250, 250, 250))
        
        rectangle = pygame.Rect(150, 450, 100, 40)
        pygame.draw.rect(screen, (100, 50, 100), rectangle)
        #gets rectangle that can be used to allow collide point
        
        screen.blit(text_rect, (165, 460)) 
        ...
        for event in events:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if collide:
                    ...
                    if len(loser_t) <= 0:
                        retry = rect_txt.render("Please type your initials!!", True, (250, 250, 250))
                        screen.blit(retry, (80, 355))
                        pygame.display.flip()
        ...
        pygame.draw.rect(screen, (250, 250, 250), user_inp)
...
def Mode(username):
    ...
    while menu:
        ...
        user_txt = pygame.font.SysFont('Corbel', 50)
        user = user_txt.render("Select a Mode", True, (250, 250, 250))
        user_rect = user.get_rect(center=(200, 115))
        #creates text for title and shows it on the screen

        mode1t = pygame.font.SysFont('Corbel', 50)
        mode1 = mode1t.render("Classic", True, (0, 0, 0))
        mode1_rect = mode1.get_rect(center=(200, 220))
        m1_rectangle = pygame.Surface((200,70))
        m1_rectangle.fill((250,250,250))
        #also creates text and shows it on the screen
        
        rect1 = pygame.Rect(100,180,200,70)

        #FIRST MODE VISUAL CODE ^^^^^

        mode2t = pygame.font.SysFont('Corbel', 50)
        mode2 = mode2t.render("Speed", True, (0, 0, 0))
        mode2_rect = mode2.get_rect(center=(200, 320))
        m2_rectangle = pygame.Surface((200,70))
        m2_rectangle.fill((250,250,250))

        rect2 = pygame.Rect(100,280,200,70)

        #SECOND MODE VISUAL CODE ^^^^^
        
        mode3t = pygame.font.SysFont('Corbel', 50)
        mode3 = mode3t.render("Coin Hunt", True, (0, 0, 0))
        mode3_rect = mode3.get_rect(center=(200, 420))
        m3_rectangle = pygame.Surface((200,70))
        m3_rectangle.fill((250,250,250))

        rect3 = pygame.Rect(100,380,200,70)

        #THIRD MODE VISUAL CODE ^^^^^^

        boardT = pygame.font.SysFont('Corbel', 50)
        board = boardT.render("Score Board", True, (0, 0, 0))
        board_rect = board.get_rect(center=(200, 520))
        m4_rectangle = pygame.Surface((200,70))
        m4_rectangle.fill((250,250,250))

        rect4 = pygame.Rect(100,480,200,50)
        ...
        screen.blit(user, user_rect)
        screen.blit(m1_rectangle, (100,180))
        screen.blit(mode1,mode1_rect)
        
        screen.blit(m2_rectangle, (100,280))
        screen.blit(mode2,mode2_rect)

        screen.blit(m3_rectangle, (100,380))
        screen.blit(mode3,mode3_rect)

        screen.blit(m4_rectangle, (100,480))
...
def Score_Screen():
    ...
    while S_S:
        ...
        classic_head = slay_head.render("Classic", True, (12, 192, 224))
        screen.blit(classic_head, (158, y_pos-30))
        for n in names[0]:
            n = n[:3].upper()
            slay = slay_queen.render (n, True, (12, 192, 224))
            screen.blit(slay, (100, y_pos))
            y_pos += 30
        for s in scores[0]:
            slayscores = slay_queen.render (".................. " + str(s), True, (12, 192, 224))
       ...
       # speed mode leaderboard
        y_pos += 30
        speed_head = slay_head.render("Speed", True, (12, 192, 224))
       ...
       # coins mode leaderboard
        y_pos += 30
        coins_head = slay_head.render("Coins", True, (12, 192, 224))
...
def Coin_hunt(U_name):
    ...
    while running:
        ...
        if (main_y >= screen.get_height() - Flappy.image.get_height()) or main_y <= 0:
            ...
            running = False
        #Adds borders so bird cant fly out of window
        ...
        for coin in coinsli:
           for obstacle in obstacles:
               ...
               offset3 = [obstacle.x+60 - coin.x, 0 - coin.y]
               #finds the distance between the two objects

               if coin.mask.overlap(obstacle.mask1, offset1):
                  coinsli.pop(coinsli.index(coin))
